...
class BootStrap {
    ...
    void initData() {
        ...
        Variation mini = new Variation(phone: s1, variation: "samsung s1 mini").save(flush: true)
        Variation large = new Variation(phone: s1, variation: "samsung s1 large").save(flush: true)

        Variation mini1 = new Variation(phone: s2, variation: "samsung s2 mini").save(flush: true)
        Variation large1 = new Variation(phone: s2, variation: "samsung s2 large").save(flush: true)

        Variation mini2 = new Variation(phone: note1, variation: "samsung note1 mini").save(flush: true)
        Variation large2 = new Variation(phone: note1, variation: "samsung note1 large").save(flush: true)
